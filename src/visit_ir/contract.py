# -*- coding: utf-8 -*-
"""合同-相位本体 (Contract-Cadence-Phase) — VisitIR 语义核心.

> 出处: 自母项目 visit-scheduling-optimizer `core/contract.py` 剥离 (2026-09-06,
> 用户裁定"先做 IR"); 母项目经 shim 消费本模块. 语义定稿依据:
> 母项目 docs/design/CONTRACT_CADENCE_MODEL.md (SRP 数据 1,524 店精确重构零例外).
